...
- Include the appropriate disclaimer based on detected YMYL vertical. Place it at the top of the page, after the introduction but before the first H2. Set it off with blank lines above and below so it does not blend into body text.
...
- Soft educational CTA only. Place one CTA near the end of the page, before the FAQ section. Options: "Read our guide on [related topic]", "Sign up for our newsletter for more research-backed guides", "Download our free [related resource]". Never "buy now", "shop our products", or "try our supplement."
...
- Review for: clarity, specificity, non-commodity quality, brand voice alignment, factual accuracy, structural flow, CTA appropriateness (soft educational only), SEO basics (title, headings, meta description), paragraph length, H2 keyword presence, structural variation, reading level (grade 5-6).
...
- YMYL SPECIFIC CHECKS (run every one, do not skip):
  ...
  9. Is the CTA soft and educational (not a product pitch)?
...
Every line of the draft has been reviewed. Every YMYL check completed. Every banned pattern has been checked via literal match. Every citation verified (in-text/citation-section match). All sources checked for credibility. Engagement quality assessed. Prioritized fix list is complete with specific evidence. Visual spacing checked: horizontal rules present between all H2 sections, paragraph rhythm varied, disclaimer has visual separation.
...
- YMYL VERIFICATION PASS: Re-check every YMYL requirement: disclaimer present, citations numbered and matching, sources credible, no medical claims, no dosage recommendations, soft educational CTA only, tone measured and not lecturing.
...
All Critical and Needs Work items addressed. YMYL verification passed. Banned patterns re-scanned and clean. Engagement techniques present (minimum 3, adapted for measured authority). Reading level verified at grade 5-6. All claims cited with matching MLA citations. No medical claims. No dosage recommendations. Disclaimer present and correct. Soft educational CTA placed. FAQ present if required. Internal links included. Third person maintained. Title tag, meta description, and slug written. Visual layout pass complete: horizontal rules between all sections, paragraph rhythm varied, disclaimer and callouts have breathing room.
...
| **Disclaimer rule** | Every page must include a disclaimer after the introduction and before the first H2. Health: "The information on this page is for educational purposes only. It is not intended to diagnose, treat, cure, or prevent any disease. Consult a healthcare professional before making changes to your supplement routine or skincare regimen. Statements on this page have not been evaluated by the Food and Drug Administration (FDA)." |
| **CTA rule** | Soft educational CTA only. Place one CTA near the end of the page, before the FAQ section. Never product pitches, "buy now", "shop our products", or "try our supplement." |
...
| 16 | Product pitches disguised as educational content | "[Client's product name] is the best source of...", "Look for supplements like [client product] that...", "That's why we created [product]..." | The page is educational content. The client is the publisher, not the subject. Product mentions, if any, go only in the soft educational CTA at the end. |
...
19. Include the correct disclaimer after the introduction and before the first H2. Set it off with blank lines above and below.
...
24. Soft educational CTA only. No product pitches in main content.
25. Tone: measured authoritative, conversational but serious. Not lecturing.
